...
데이터 모델| SQL:관계형 모델  NoSQL:비관계형 모델
스키마| SQL:고정된 스키마  NoSQL:동적인 스키마
확장성| SQL:수직적 확장  NoSQL:수평적 확장
적합성| SQL:정형 데이터  NoSQL:비정형 및 반정형 데이터
쿼리 언어| SQL:SQL 표준 언어 사용  NoSQL:다양한 API와 언어 사용 가능
유연성| SQL:낮음  NoSQL:높음
